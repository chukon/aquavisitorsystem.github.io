...
.then((querySnapshot) => {
    ...
    document.getElementById("numcount").innerHTML = Math.ceil(growCount / 2); //uniqueSet2.size;
    document.getElementById("numcount").setAttribute("value", Math.ceil(growCount / 2));
})
    .catch((error) => {
        console.log("Error getting documents: ", error);
});
