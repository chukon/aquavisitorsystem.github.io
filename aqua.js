...
var utcTime = date.toUTCString();
  ...
  log_create();
   ...
   return datum/1000;
    ...
    .then((querySnapshot) => {
          var cnt = querySnapshot.size;
		  var title = "<center><h1>Aqua-Aerobic Systems Check-in/out Log</h1><h2>" + cnt + " Check-in/Check-out sessions for: " + get_login + "</h2><a href='https://aquavisitorsystem.github.io/'>Go Home</a><br><br></center>";
 		  document.write(title);
...
var loadweekschedule =  function(){
   ...
   document.write("");
    ...
    .then((querySnapshot) => {
	 console.log("Snapshot:" + querySnapshot.size); 
        var cnt = querySnapshot.size;
	 var title = "<center><h1>Aqua-Aerobic Systems Visitor System</h1><h2>" + cnt + " Check-in/Check-out sessions for: " + name + "</h2></center><center><a href='https://aquavisitorsystem.github.io/'>Go Home</a></center><br>";         
	document.write(title);
	document.write(printnow);
	//document.write("<center><h3>Find your name and Tap 'Check-In'</b></center></h3>If your name is not found below, click <a href='" +  "https://ignitemeeting.github.io/?ipad=Yes"   + "'>here</a> to continue!<br><br><center>");
        if (cnt === 0){
...
"msg": msg.value.trim().toUpperCase(),
 ...
 document.getElementById('loginlabel').innerText = 'Aqua Employee User ID OR Keyword';
  document.getElementsByName('login')[0].placeholder = '[KEYWORDS] today, name, date, all, inactive, logname, logall, logtoday';
	       	          document.getElementById('emaillabel').style.display = 'none';
