...
var utcTime = date.toUTCString();
  ...
  log_create();
   ...
   return datum/1000;
    ...
    .then((querySnapshot) => {
          var cnt = querySnapshot.size;
		   var title = "<center><h1>Aqua-Aerobic Systems Check-in/out Log</h1><h2>" + cnt + " Check-in/Check-out sessions (" + (cnt / 2) + " visitor(s))</h2><a href='https://aquavisitorsystem.github.io/'>Go Home</a><br><br></center>";
		  document.write(title);
		 document.write(printnow);
	 if (cnt === 0){
		 var nodata = "<center><br>No visitor data found<br></center>";
